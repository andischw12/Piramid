// Description : Menu_Manager_Pc.cs : Use in association with Menu_ManagerEditor.cs . Use to navigate on menu page. open and close pages
using System.Collections;
using System.Collections.Generic;
using UnityEngine;


public class Menu_Manager_Pc : MonoBehaviour {
...
// --> Button on Menu call this function to go to a new page with his number on list
    ...
    public void DeactivateCLueMode(){
        if(AP_GlobalPuzzleManager_Pc.instance)
            AP_GlobalPuzzleManager_Pc.instance.b_IsClueActivated = false;
    }
