//Description : JoystickReticuleEditor_Pc : JoystickReticule custom editor
#if (UNITY_EDITOR)
using UnityEngine;
...
[CustomEditor(typeof(JoystickReticule_Pc))]
public class JoystickReticuleEditor_Pc : Editor {
	SerializedProperty			SeeInspector;											// use to draw default Inspector
	SerializedProperty 			sensibilityJoystick;
	//SerializedProperty 			animationCurveJoystick;
    SerializedProperty          cNoSelection;
    SerializedProperty          cSelection;
	...
	void OnEnable () {
        ...
        cNoSelection = serializedObject.FindProperty("cNoSelection");
        cSelection = serializedObject.FindProperty("cSelection");



        JoystickReticule_Pc myScript = (JoystickReticule_Pc)target; 
...
//--> Animation Curve
        ...
        */
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.Label("Selection : ", GUILayout.Width(120));
        EditorGUILayout.PropertyField(cNoSelection, new GUIContent(""));
        EditorGUILayout.EndHorizontal();

        EditorGUILayout.BeginHorizontal();
        GUILayout.Label("No Selection : ", GUILayout.Width(120));
        EditorGUILayout.PropertyField(cSelection, new GUIContent(""));
        EditorGUILayout.EndHorizontal();
