//Description : CanvasDEditor_Pc : CanvasD_Pc custom editor
#if (UNITY_EDITOR)
using UnityEngine;
...
[CustomEditor(typeof(CanvasD_Pc))]
public class CanvasDEditor_Pc : Editor {
	...
	public override void OnInspectorGUI()
	{
		...
		GUILayout.Label("");
        CanvasD_Pc myScript = (CanvasD_Pc)target;
