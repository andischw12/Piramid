// Description : Menu_ManagerEditor_Pc.cs : Use in association with Menu_Manager.cs . Allow to create Menu Page. 
#if (UNITY_EDITOR)
using UnityEngine;
...
[CustomEditor(typeof(Menu_Manager_Pc))]
public class Menu_ManagerEditor_Pc : Editor {
	...
	public override void OnInspectorGUI()
	{
        ...
        Menu_Manager_Pc myScript = (Menu_Manager_Pc)target; 
