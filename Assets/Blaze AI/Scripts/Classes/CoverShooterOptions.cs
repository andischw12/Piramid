...
namespace BlazeAISpace 
{
    ...
    public class CoverShooterOptions 
    {
        ...
        [Tooltip("If set to true, the agent will move to the center transform of the cover obstacle, if false, will be in cover the moment the obstacle hides the agent from enemy.")]
