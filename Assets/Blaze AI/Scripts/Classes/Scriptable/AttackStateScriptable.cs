...
namespace BlazeAISpace
{
    ...
    public class AttackStateScriptable 
    {
        ...
        [Tooltip("The distance between the NPC and the enemy to deliver the actual attack. So for example: if this NPC is to punch the enemy then it needs to get pretty close. This can't be bigger or equal to [Distance From Enemy].")]
        ...
        [Tooltip("Check whether you always want the npc to keep looking at the enemy on attack. If disabled, npc won't change rotation to enemy direction when attack starts.")]
